  ...
  const content = [
    {
      ...
      explanation:
        'Welcome to GuideFox. Please customize your dashboard experience here.',
    },
    {
      title: 'Install GuideFox now?',
      explanation:
        'You’ll need a small extension to use create, edit and preview your onboarding items. Your end users don’t need to install this.',
    },
    {
    ...
    },
    {
      ...
      explanation:
        'You have successfully set up your account. <br> What next? Start adding a guide, hint or a tour in your app',
    },
  ];
      ...
      <>
        <div className={styles.stepOne}>
          ...
          <div className={styles.teamMembers}>
            ...
            <TeamMembersList
              members={teamMembersEmails}
              setMembers={setTeamMembersEmails}
            />
          </div>
        </div>
        <div className={styles.buttons}>
          <Button
            text="Next"
            sx={{ width: '107px', borderRadius: '10px !important' }}
  ...
  const thirdPage = () => {
    return (
      <>
        ...
        {orgError && (
          <div className={styles.errorMessage}>{orgErrorMessage}</div>
        )}
        <div className={styles.buttons}>
          <Button
            text="Previous"
      ...
      <>
        <div className={styles.buttons}>
          ...
          <Button
            text="Sweet"
            sx={{ width: '148px', borderRadius: '10px !important' }}
            onClick={() => sendInvitesAndSetOrgName()}
            startIcon={
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <h3
          dangerouslySetInnerHTML={{ __html: content[step - 1].explanation }}
        />
        {pages[step - 1]()}
      </div>
    </div>
